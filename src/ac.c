...
TrieIndex step(Trie *trie, TrieIndex node, TrieChar character) {
//    while (true) {
//        TrieBase base = trie_getBase(trie, node);
//        TrieIndex check = trie_getCheck(trie, node + character);
//
//    }
}

void buildAutomaton(Trie *trie) {
